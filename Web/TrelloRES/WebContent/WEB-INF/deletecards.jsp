	...
	<div id="main-boards">
		...
		<div id="deleteBoard">
			...
			<form method="post" action="DeleteCardServlet">
				...
				<h3> "${cardName}" will be removed</h3>
				<h2>Are you sure?</h2>
				<input type="hidden" name="cardId" value="${cardId}">
			<a  href="DeleteCardServlet"><button class="boton-si" >YES</button></a>
			<a class="boton-no" href="CardServlet?listName=${listName}&listId=${listId}&cardId=${cardId}">NO</a>
