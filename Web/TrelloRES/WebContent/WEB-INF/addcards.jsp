...
<body id="body-list">
	...
	<div id="main-lists">
		...
		<div class="myLists">
			...
			<h1> <a href="SetBoardServlet?boardId=${boardId}&boardName=${boardName}">${boardName}</a> </h1>

			<div id="addlist">
				<form method="get" action="AddListServlet">

					<input type="text" name="nameNewList" placeholder="Add a list..." maxlength=”39” required>
	...
	<div id="content-list">
		...
		<c:forEach var="list" items="${listsList}">
			<div class="list">
		 	...
		 	<c:if test="${list.id eq listId}">
				
				<form id="newCard" method="post" action="AddCardServlet">
					<input type="text" name="nameNewCard" placeholder="Add a card..." maxlength=”39” required> 
