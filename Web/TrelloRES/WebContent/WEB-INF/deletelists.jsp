...
<body>
	...
	<div id="main-boards">
		...
		<div id="deleteBoard">
			...
			<form method="post" action="DeleteListServlet">

				<h3> "${listName}" will be removed</h3>
				<h2>Are you sure?</h2>
				<input type="hidden" name="listId" value="${listId}">
			<a  href="DeleteListServlet"><button class="boton-si" >YES</button></a>
			<a class="boton-no" href="ListServlet?boardName=${boardName}&boardId=${boardId}">NO</a>
