...
public class MensajeListAdapterGrupo extends BaseAdapter {
	...
	public MensajeListAdapterGrupo(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mensajeItem.getImagen() != null) {
			...
			if (mensajeItem.getTipo() == Tipo.ENVIADO) {
				...
				// Display EmisorMensaje in TextView
				final TextView textViewEmisorMensaje = (TextView) itemLayout
						.findViewById(R.id.TextViewEmisor);
				textViewEmisorMensaje.setText(mensajeItem.getEmisor());
			...
			if (mensajeItem.getTipo() == Tipo.ENVIADO) {
				itemLayout = (RelativeLayout) LayoutInflater.from(mContext)
						.inflate(R.layout.mensaje_item_r_grupo, null);
				...
				itemLayout = (RelativeLayout) LayoutInflater.from(mContext)
						.inflate(R.layout.mensaje_item_l_grupo, null);
